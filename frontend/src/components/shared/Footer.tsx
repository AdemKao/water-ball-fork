...
const socialLinks = [
  {
    name: "Line",
    href: "https://line.me/ti/g2/waterball",
    icon: (
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/waterballsa",
    icon: (
      <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: "Discord",
    href: "https://discord.gg/waterball",
    icon: (
      <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: "Youtube",
    href: "https://www.youtube.com/@waterballsa",
    icon: (
      <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
...
export function Footer() {
  ...
  return (
    <footer className="bg-[#1B1B1F] text-white">
      <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-400 text-sm max-w-md">
                致力於提供高品質的軟體開發課程，幫助開發者提升技術能力，實現職涯突破。
              </p>
            </div>
            ...
            <div>
              <h4 className="font-semibold mb-4 text-white">社群連結</h4>
        ...
        <div className="border-t border-gray-800 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              &copy; {currentYear} 水球軟體學院. All rights reserved.
            </p>
